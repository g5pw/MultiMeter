...
- (NSMutableArray *) getSerialPorts {
	io_object_t serialPort;
	io_iterator_t serialPortIterator;
	CFMutableDictionaryRef classesToMatch;
    kern_return_t kernResult;
    NSMutableArray *ports = [NSMutableArray arrayWithCapacity:5];
	...
	while ((serialPort = IOIteratorNext(serialPortIterator))) {
		[ports addObject:
			(__bridge NSString*)IORegistryEntryCreateCFProperty(serialPort, CFSTR("IOTTYDevice"),  kCFAllocatorDefault, 0)];
